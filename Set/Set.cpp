...
int main() {
    ...
    Set mySet = {3, 4, 7, 1, 2, 9, 8, 6, 5, 10};

    mySet.insert_s(11);
    mySet.insert_s(2);

    std::cout << "Contains 5: " << (mySet.contains(5) ? "true" : "false") << "\n";
    std::cout << "Contains 15: " << (mySet.contains(15) ? "true" : "false") << "\n";
    std::cout << "Tree elements: ";
    mySet.display(mySet.root);
    std::cout << std::endl;
